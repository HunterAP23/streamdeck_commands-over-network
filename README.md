...
Send StreamDeck commands to devices over the internet.
...
This project will use the README for general information, while the bulk of the
documentation will be auto-generated by Doxygen.
Code commenting and documentation should follow Doxygen standards when possible,
and is publicly available in the [GitHub Pages](https://hunterap23.github.io/streamdeck_commands-over-network/).
